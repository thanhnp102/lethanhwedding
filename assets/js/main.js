const RSVP_ENDPOINT =
  "https://script.google.com/macros/s/AKfycbypUt14ZYrBpMnIdpXlgblLCHhlMFRlJbGpSsoXUzPXAbmP_3w6zbTqEAlqsDFtUIQ5/exec"; // <-- dán URL Web App của Google Apps Script vào đây
...
(function () {
  ...
  function applyGuest(en) {
    ...
    if (we) {
      if (en) {
        ...
        we.textContent = senior.indexOf(first) >= 0 ? "chúng em" : "chúng mình";
      } else {
  ...
  document
    ...
    .addEventListener("click", () => giftWrap.classList.remove("flipped"));
